...
class AgentApi:
    ...
    def use_item(
        ...
        :param use_request: (required)
        :type use_request: UseRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._use_item_serialize(
    ...
    @validate_call
    def use_item_without_preload_content(
        self,
        use_request: UseRequest,
        _request_timeout: Union[
            None,
    ...
    def _use_item_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if use_request is not None:
            _body_params = use_request

...
from veil.configuration import Configuration
from veil.api_response import ApiResponse, T as ApiResponseT
import veil.models
from veil import rest
from veil.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(veil.models, klass)

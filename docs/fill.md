...
Build order stays **Increments** at the bottom. Chrome execute against origin is proven (CFT + branded 2026-09-14). Next is **replica** (increment 7). Do not build `safari` until Chrome + Firefox work. Generate and passkeys are not a gate on replica.

...
Build order stays **Increments** at the bottom. Chrome execute against origin is proven (CFT + branded 2026-09-14). Replica is live. Next is **cards** (increment 8). Do not build `safari` until Chrome + Firefox work. Firefox is after cards work, not in the same cut.

...
Build order stays **Increments** at the bottom. Chrome execute against origin is proven (CFT + branded 2026-09-14). Replica is live. Cards + identities are CFT-proven; branded HTML checkout wrote field lengths 2026-09-15. Next is **Firefox**. Do not build `safari` until Chrome + Firefox work. Firefox is after cards work, not in the same cut.
